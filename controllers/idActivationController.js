...
exports.applyNewIdActivPostController = (req, res) => {
    ...
    let message =
        `Congratulation! You have successfully applied to activated your new account. Our team takes a little bit amount of time to activate your account process. Thanks for cooperating with us.
        ...
        async (error, result) => {
            if (error) {
                ...
                try {
                    ...
                    req.flash('profileSueccFlash', 'Congratulation! You have successfully applied to activated your new account. Our team takes a little bit amount of time to activate your account process. Thanks for cooperating with us.');
                    res.redirect('/profile');
                } catch (error) {
...
exports.upgradPackgPostController = (req, res) => {
    ...
    let message =
        `You have successfully applied to upgrade your package. Our team takes a little bit amount of time to activate your account process. Thanks for cooperating with us.
        Submited Information
        ...
        async (error, result) => {
            ...
            if (error) {
                ...
                try {
                    ...
                    req.flash('profileSueccFlash', 'You have successfully applied to upgrade your package. Our team takes a little bit amount of time to activate your account process. Thanks for cooperating with us.');
                    res.redirect('/profile');
                } catch (error) {
                    req.flash('profileErrorFlash', 'There was error sending the email!');
                    return res.redirect('/profile');
